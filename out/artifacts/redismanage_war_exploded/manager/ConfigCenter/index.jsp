	...
	<div class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a href="<%=path%>/configcenter/index?key=component_category" id="config">配置项维护</a></li>
            ...
            <div class="panel-body" id="leftTree">
            	<%
            		for (int i=0; i<list.size(); i++) {
            			...
            			if (0 == i) {
            				%>
                			<a href="javascript:void(0)" value="<%=m.get("field") %>" class="list-group-item active"><%=m.get("value") %></a>
                			<%
            			} else {
            				%>
                			<a href="javascript:void(0)" value="<%=m.get("field") %>" class="list-group-item"><%=m.get("value") %></a>
                			<%
            			}
...
$(function () {
	...
	$('#key').val('<%=list.size()>0?list.get(0).get("field"):"" %>');
