...
<%
    ...
    Set<String> list = (Set<String>)request.getAttribute("list");
	...
	<div class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a href="<%=path%>/configcenter/tam?key=adgroup" id="tamcongroup">TIM</a></li>
  ...
  <div class="panel-body" style="padding-bottom:0px;">
	<div class="row">
		...
		<div class="col-md-2">
            ...
            <div class="panel-heading" id="tname">目录</div>
            <div class="panel-body" id="leftTree">
                <form id="myform1" action="<%=path%>/configcenter/tam">
                <select onchange="tnameChange(this);" name="key">
                    <option value="adgroup" <%="adgroup".equals(key)?"selected":""%>>认证群组</option>
                    <option value="timpeople" <%="timpeople".equals(key)?"selected":""%>>身份用户</option>
                    <option value="timaccounts" <%="timaccounts".equals(key)?"selected":""%>>身份帐号</option>
                </select>
                </form>
                <%
                    String firstKey = "";
            		...
            		for (String kk : list) {
            			...
            			if (0 == i) {
            			    firstKey = kk;
            				%>
                			<a href="javascript:void(0)" value="<%=kk %>" class="list-group-item active"><%=kk %></a>
                			<%
            			} else {
            				%>
                			<a href="javascript:void(0)" value="<%=kk %>" class="list-group-item"><%=kk %></a>
                			<%
            			}
            			i++;
            		}
...
var tnameChange = function(d) {
    debugger;
    //$('#tname').text($(d).find("option:selected").text());
    var f1 = document.getElementById('myform1');
