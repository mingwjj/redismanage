		...
		<div class="container-fluid">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="">组件维护</a></li>
          			<li><a href="<%=path%>/configcenter/index?key=component_category">配置项维护</a></li>
					<li><a href="<%=path%>/manager/ConfigCenter/erds.jsp">资源目录</a></li>
            ...
            <div class="panel-body">
                <form id="formSearch" class="form-horizontal">
                    <div class="form-group" style="margin-top:15px">
                        <label class="control-label col-sm-1" for="txt_search_field">组件代码</label>
                        <div class="col-sm-3">
                        	<input name="key" type="hidden" id="key" value="component_category"/>
                            <input type="text" class="form-control" id="txt_search_field">
                        </div>
                        <label class="control-label col-sm-1" for="txt_search_value">组件名称</label>
                        <div class="col-sm-3">
					...
					<div class="modal-body">
						<form>
							<div class="form-group">
								<label for="field">组件代码</label>
								<input type="text" placeholder="*-portlet" id="field" name="field" class="form-control" />
							</div>
							<div class="form-group">
								<label for="value">组件名称</label>
								<input type="text" placeholder="中文名称" id="value" name="value" class="form-control"/>
							</div>
						</form>
					</div>
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_components').bootstrapTable({
            url: '${pageContext.request.contextPath}/configcenter/ccList',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
var ButtonInit = function () {
    ...
    oInit.Init = function () {
        ...
        $('#btn_query').click(function () {
        	$('#tb_components').bootstrapTable('refresh');
        });
        ...
        $('#btn_edit').click(function () {
            var arrselections = $('#tb_components').bootstrapTable('getSelections');
        ...
        $('#btn_delete').click(function () {
            ...
            Ewin.confirm({ message: '确认要删除选择的数据吗？' }).on(function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '${pageContext.request.contextPath}/configcenter/ComponentCategory_delete',
                    data: { 
                    	key : $('#key').val(),
                    	fields : fields
                    },
        ...
        $('#btn_submit').click(function () {
            ...
            $.ajax({
                type: 'post',
                url: '${pageContext.request.contextPath}/configcenter/ComponentCategory_addOrUpdate4ajax',
                data: { 
